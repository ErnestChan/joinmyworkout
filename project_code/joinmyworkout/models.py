...
class User(models.Model):
	...
	registered_date = models.DateTimeField('Date Registered') #date user registered
...
class Workout_Event(models.Model):
	...
	experience_level = models.ForeignKey(Event_Class_To_Experience_Level, on_delete=models.CASCADE)
